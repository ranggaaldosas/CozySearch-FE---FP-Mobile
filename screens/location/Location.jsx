...
const LocationComponent = () => {
  ...
  const [nearbyKost, setNearbyKost] = useState([]);

  const fetchNearestKost = async () => {
  ...
  useEffect(() => {
    console.log("Fetching nearest dorms...")
    fetchNearestKost();
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Recommendations data={nearbyKost} currentLocation={currentLocation} />
      </View>
    </View>
  );
};
